...
from mist_cf.xformer_score import xformer_data, xformer_model
...
def train_model():
    ...
    test_dataset = xformer_data.XformerDataset(
        test_df,
        data_dir=data_dir,
        max_decoy=args.max_decoy,
        val_test=True,
    ...
    model = xformer_model.XformerModel.load_from_checkpoint(best_checkpoint)
    logging.info(
