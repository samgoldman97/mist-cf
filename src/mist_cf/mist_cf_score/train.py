...
def add_args(parser):
    ...
    parser.add_argument(
        "--batch-size", default=16, action="store", type=int, help="Set batch size"
    )
    parser.add_argument(
        "--max-epochs",
        default=100,
    ...
    parser.add_argument(
        ...
        action="store",
        type=int,
        help="Set maximum number of decoy to subsample during mist_cf training due to GPU memory constraint",
    )
    parser.add_argument(
        "--max-subpeak",
        type=int,
        default=10,
        help="Maximum number of subpeaks for each candidate formula",
    )
    date = datetime.now().strftime("%Y_%m_%d_%H")
    parser.add_argument(
        "--save-dir",
        default=f"results/mist_cf_model/{date}_mist_cf_train/",
    ...
    parser.add_argument(
        "--decoy-label",
        type=str,
        default="data/canopus_train/label_decoy_COMMON_256.tsv",
        help="Path to decoy label",
    )
    parser.add_argument(
        "--subform-dir",
        type=str,
        default="data/canopus_train/subformulae/formula_spec_label_decoy_COMMON_256",
    ...
    parser.add_argument(
        ...
        action="store",
        type=int,
        help="Number of layers of mist_cf",
    )
    parser.add_argument(
        "--dropout",
        default=0.1,
        action="store",
        type=float,
        help="Dropout parameter of mist_cf",
    )
    parser.add_argument(
        "--hidden-size",
        default=256,
        action="store",
        type=int,
        help="Hidden size parameter of mist_cf",
    )
    parser.add_argument(
        "--weight-decay",
        default=0.0,
    ...
    parser.add_argument(
        ...
        default=False,
        action="store_true",
        help="Use one hot encoding of instrument information flag",
    )
    parser.add_argument(
        "--no-cls-mass-diff",
        default=False,
        action="store_true",
        help="Set cls ppm to 0 to ablate its influence",
    )
