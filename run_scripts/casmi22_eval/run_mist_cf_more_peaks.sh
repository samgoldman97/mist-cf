...
mkdir results/mist_cf_predict_casmi22_50_peaks/
...
python src/mist_cf/mist_cf_score/predict_mgf.py \
    ...
    --num-workers 32 \
    --batch-size 8 \
    --save-dir results/mist_cf_predict_casmi22_50_peaks/ \
    --mgf-file data/casmi22/CASMI_processed.mgf \
    --checkpoint-pth results/mist_cf_nist_max_subpeak/max_subpeak_50_1/version_0/best.ckpt \
