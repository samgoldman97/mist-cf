...
results = [
    dict(
        save_dir="results/mist_cf_predict_sirius/mist_cf_1",
        split=f"data/{dataset}/splits/split_1.tsv",
    ),
    dict(
        save_dir="results/mist_cf_predict_sirius/mist_cf_2",
        split=f"data/{dataset}/splits/split_2.tsv",
    ),
    dict(
        save_dir="results/mist_cf_predict_sirius/mist_cf_3",
        split=f"data/{dataset}/splits/split_3.tsv",
    ),
    dict(
        save_dir="results/sirius_gnps_pred/sirius_1/",
        split=f"data/{dataset}/splits/split_1.tsv",
    ),
    dict(
        save_dir="results/sirius_gnps_pred/sirius_2/",
        split=f"data/{dataset}/splits/split_2.tsv",
    ),
    dict(
        save_dir="results/sirius_gnps_pred/sirius_3/",
        split=f"data/{dataset}/splits/split_3.tsv",
    ),
]
